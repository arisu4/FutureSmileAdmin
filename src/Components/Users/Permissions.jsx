...
//     const {value,status,checked,name,id} = e.target
//     console.log('before permissions',permissions);
//     for(let x of permissions){
//       if(x.id == id){
//         if(x.module_access == 1){
//           x.module_access=0
//         }else if(x.module_access==0){
//           x.module_access=1
//         }
//       }
//     }
//     console.log('after permissions',permissions);
//   }

//   const handleChange =(event)=>{
//     const {value,status,checked,name,id} = event.target
//     //console.log('checked',checked);
//     const obj={
//       id:id,
//       name:name,
...
//         <td><input type="checkbox" value="1" status={datas.module_access} id={datas.id} onChange={handleChange}  name="module_access"  checked = {datas.module_access == 1}/></td>
...
//     //console.log("all values",value,checked)
//     if(checked){
//          setInput([
//           ...input,value
//          ])
//     }
//     else{
//          setInput(input.filter((e)=>(e!==value)))
//     }
//   }
...
//         <td><input type="checkbox"  onChange={handleChange} value={datas.id} name="module_access" /></td>
//         <td><input type="checkbox"  onChange={handleChange}  value={datas.id}  name="sub_module_access" /></td>
//         <td><input type="checkbox"  onChange={handleChange}  value={datas.id} name="access_item" /></td>
//         <td><input type="checkbox"  onChange={handleChange}  value={datas.id} name="add_item" /></td>
//         <td><input type="checkbox"  onChange={handleChange}   value={datas.id} name="edit_item" /></td>
//         <td><input type="checkbox"  onChange={handleChange}  value={datas.id} name="details_item" /></td>
//         <td><input type="checkbox"  onChange={handleChange} value={datas.id}  name="delete_item" /></td>
//         <td><input type="checkbox"  onChange={handleChange} value={datas.id}  name="status_item"  /></td>
//       </tr>
//     )
//   }
