...
function EditTeam() {
    ...
    const getTeambyId = async() => {
        await axios.get(`${baseURL}/admin/about/editmember/${id}`)
            .then(response => {
                const { editteams } = response.data;
                setEdit(editteams);
            })
            .catch(error => {
                console.log(error)
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    <li className="breadcrumb-item"><Link to=""></Link>Team</li>
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    ...
                                    <div className="form-group">
                                        <label>Name</label>
                                        <input type="name" name="title" className="form-control" placeholder="Enter Name" onChange={textHandle} defaultValue={edit.name} />
                                        <span id="titleError" style={{ color: 'red', backgroundColor: '', fontSize: "14px" }}>{errors?.name}</span>
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    {/* text input */}
                                    <div className="form-group">
                                        ...
                                        <input type="name" name="title" className="form-control" placeholder="Enter Designation" onChange={textHandle} defaultValue={edit.designation} />
                                        <span id="titleError" style={{ color: 'red', backgroundColor: '', fontSize: "14px" }}>{errors?.name}</span>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <img src={process.env.REACT_APP_PUBLIC_TEAM+edit.image} height={150} alt="team.jpg"/>
