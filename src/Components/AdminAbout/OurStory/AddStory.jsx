...
function AddStory() {
  ...
  const handleSubmit = (e) => {
    ...
    Array.from(image).forEach(images=>{
            ...
            <div className="row mb-2">
              ...
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  <li className="breadcrumb-item"><a href="/link">Stories</a></li>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="form-group">
                    <label>Image </label>
                    <input type="file" name="image" className="form-control" placeholder="Enter Image" accept = "image/png,image/jpeg,image/jpg,image/webp" multiple onChange={imageHandle}   />
                ...
                <div className="col-sm-6">
                  <div className="form-group">
                    ...
                    <textarea className="form-control" name="description" rows={3} placeholder="Enter Description" defaultValue={""} onChange={textHandle} />
